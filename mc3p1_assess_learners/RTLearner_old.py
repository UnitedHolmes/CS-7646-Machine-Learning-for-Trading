# -*- coding: utf-8 -*-
"""
Created on Tue Jun 20 15:04:08 2017
...
#            self.factor[ind] = i
            ...
            while (dataX[row_1,i] == dataX[row_2,i]):
                ...
                if trials_row2 >= 10:
                    i_old = np.hstack(i_old,i)
                    trials_row2 = 0
                    # if all feature has been picked
                    if i_old.shape[0] == dataX.shape[1]:
                        if dataY[row_1] != dataY[row_2]:
                            meanY = (dataY[row_1] + dataY[row_2]) / 2
                            dataY[row_1] = meanY
                            dataY[row_2] = meanY
                    # if not, repick a new feature i
                    else:                        
                        while any(i==i_old):
                            i = np.random.random_integers(0,dataX.shape[1]-1)
